-- Restructure institution categories:
--   - Merge brigades + technical-colleges → technical-colleges-brigades
--   - Add short-courses for institutions that only offer programmes up to 6 months

update public.feed_posts
set author_institution_category = 'technical-colleges-brigades'
where author_institution_category in ('brigades', 'technical-colleges');
...
begin
  ...
  if id in (
    ...
    'africa-insurance-training-institute', 'delta-training-academy'
  ) then
