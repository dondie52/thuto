-- Expand syllabus and sponsorship allow-lists for multi-country markets.
...
alter table public.profiles
  ...
  check (
    sponsorship_intent is null
    or sponsorship_intent in (
      'dtef',
      'nsfaf',
      'gov_zw',
      'helsb',
...
begin
  ...
  set
    ...
    syllabus_type = case
      when patch ? 'syllabus_type' and patch->>'syllabus_type' in (
        'bgcse', 'igcse', 'as_level', 'o_level', 'nssc', 'zimsec_o', 'zimsec_a', 'ecz', 'nsc_matric'
      )
