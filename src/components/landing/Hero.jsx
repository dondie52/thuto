...
export default function Hero() {
  return (
    <section className="relative isolate flex min-h-[min(86vh,42rem)] items-end overflow-hidden sm:min-h-[min(82vh,44rem)] sm:items-center">
      ...
      />
      <div
        className="landing-hero-shade absolute inset-0 bg-gradient-to-t from-slate-950/95 via-slate-950/70 to-slate-900/35 sm:bg-[linear-gradient(90deg,rgba(6,18,18,0.94)_0%,rgba(8,26,27,0.82)_38%,rgba(8,26,27,0.42)_66%,rgba(8,26,27,0.18)_100%)]"
        aria-hidden
      />
      <div
