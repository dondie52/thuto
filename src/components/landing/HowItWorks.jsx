const steps = [
  {
    ...
    body: "Add your subjects and grades so Thuto can work out your points the way institutions summarise them.",
    icon: (
  ...
  {
    title: "We match your points to programmes",
    body: "Thuto compares your profile to published minimums so you can see likely fits, alternatives, and what to double-check.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
  ...
  {
    title: "Explore courses, universities, and careers",
    body: "Read summaries, modules, and career ideas, then shortlist or compare programmes before you apply anywhere.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
  ...
  return (
    <section className="py-16 sm:py-20" aria-labelledby="how-heading">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-3 max-w-2xl text-base text-slate-600">Three steps from your results to a clearer shortlist.</p>
        <ol className="mt-12 grid gap-8 sm:grid-cols-3 sm:gap-6 lg:gap-8">
