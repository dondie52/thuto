...
| BIUST | 16 | https://www.biust.ac.bw/entry-requirements/ | Uses combined six-subject score; see [`ADMISSIONS-MINPOINTS.md`](../ADMISSIONS-MINPOINTS.md) for Thuto scale conversion |
...
Stubs at **Botho, BSBS (BAC), BA ISAGO, ABM, Limkokwing, FCoE, GTC** still need rows in `admission-overrides.json` once you have verified prospectus minima on the Thuto scale.
