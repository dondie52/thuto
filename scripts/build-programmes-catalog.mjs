...
function otherInstitutionStubs() {
  ...
  const biust = [
    ...
    ["biust-bsc-physics-general", "BSc Applied Physics", "Natural Sciences"],
    ["biust-bsc-geology", "BSc Applied Geology", "Natural Sciences"],
    ["biust-beng-civil", "BEng (Hons) Civil & Environmental Engineering", "Engineering"],
    ["biust-beng-mining", "BEng (Hons) Mining Engineering", "Engineering"],
    ["biust-beng-industrial", "BEng (Hons) Industrial and Manufacturing Engineering", "Engineering"],
    ...
    ["biust-bsc-chemistry-materials", "BSc Chemistry (Materials and Applied Chemistry)", "Natural Sciences"],
    ["biust-bsc-chemistry-drug-discovery", "BSc Chemistry (Drug Discovery and Development)", "Natural Sciences"],
    ["biust-bsc-chemistry-environmental", "BSc Chemistry (Environmental & Analytical Chemistry)", "Natural Sciences"],
    ["biust-bsc-forensic-science", "BSc Forensic Science", "Natural Sciences"],
    ["biust-bsc-mathematical-sciences", "BSc Mathematical Sciences", "Natural Sciences"],
    ["biust-bsc-industrial-mathematics", "BSc Industrial Mathematics", "Natural Sciences"],
    ["biust-bsc-cyber-security-digital-forensics", "BSc Cyber Security and Digital Forensics", "Technology"],
    ["biust-beng-computer-telecommunications", "BEng (Hons) Computer and Telecommunications Engineering", "Engineering"],
    ["biust-beng-electrical-communications", "BEng (Hons) Electrical and Communications Engineering", "Engineering"],
    ["biust-beng-mechatronics-industrial-instrumentation", "BEng (Hons) Mechatronics and Industrial Instrumentation", "Engineering"],
    ["biust-beng-chemical-engineering", "BEng (Hons) Chemical Engineering", "Engineering"],
    ["biust-beng-materials-metallurgical", "BEng (Hons) Materials & Metallurgical Engineering", "Engineering"],
    ["biust-beng-geological-engineering", "BEng (Hons) Geological Engineering", "Engineering"],
    ["biust-bsc-ecology-evolutionary-biology", "BSc (Hons) Ecology and Evolutionary Biology", "Natural Sciences"],
  ].map(([id, name, field]) => ({
    id,
    name,
    field,
  ...
  const limkokwing = [
    ...
    ["limkokwing-bsc-it-security", "BSc in Information Technology Security", "Technology"],
    ["limkokwing-bsc-information-systems", "BSc in Information Systems", "Technology"],
    ["limkokwing-diploma-information-technology", "Diploma in Information Technology", "Technology"],
    ["limkokwing-ba-visual-communication", "BA in Visual Communication", "Humanities"],
    ["limkokwing-ba-industrial-design", "BA in Industrial Design", "Humanities"],
    ["limkokwing-diploma-fashion-design", "Diploma in Fashion Design", "Humanities"],
    ["limkokwing-bbus-international-business", "BBus in International Business", "Business"],
    ["limkokwing-bbus-finance-banking", "BBus in Finance and Banking", "Business"],
    ["limkokwing-bbus-tourism-management", "BBus in Tourism Management", "Business"],
    ["limkokwing-bbus-hospitality-management", "BBus in Hospitality Management", "Business"],
    ["limkokwing-ba-interior-architecture", "BA in Interior Architecture", "Engineering"],
    ["limkokwing-associate-architectural-technology", "Associate Degree in Architectural Technology", "Engineering"],
    ["limkokwing-cert-construction-management", "Certificate in Construction Management", "Engineering"],
    ["limkokwing-ba-professional-communication", "BA in Professional Communication", "Humanities"],
    ["limkokwing-ba-digital-film-television", "BA in Digital Film and Television", "Humanities"],
    ["limkokwing-ba-broadcasting-journalism", "BA in Broadcasting and Journalism", "Humanities"],
    ["limkokwing-ba-events-management", "BA in Events Management", "Humanities"],
  ].map(([id, name, field]) => ({
    id,
    name,
    field,
