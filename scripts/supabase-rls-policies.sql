...
-- Apply in Supabase Dashboard → SQL Editor (once per project).
...
-- [ ] Use service role or SQL editor to set verified on a test row; confirm it appears in aggregates only then.
